				...
				<div className="p-4">
					...
					<div className="mb-3">
						<div className="flex flex-wrap items-center gap-2">
							...
							{isPurchased && (
								<Badge color="amber" title="Available for purchase from traders">
									Purchased
								</Badge>
							)}
						</div>
					...
					{shouldShowDetails && hasDetails && (
						<div className="pt-3">
							...
							{traderInfo && (
								<div className="mb-3">
									<div className="mb-2 text-xs text-zinc-500">
										Purchased from {traderInfo.traderName}:
									</div>
									<div className="flex flex-wrap gap-2">
										<Badge color="amber">
											{traderInfo.currency} (×{traderInfo.price})
										</Badge>
									</div>
								</div>
							)}
