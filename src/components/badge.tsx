...
const colors = {
	...
	blue: 'bg-blue-500/15 text-blue-700 group-data-hover:bg-blue-500/25 dark:bg-blue-500/10 dark:text-blue-400 dark:group-data-hover:bg-blue-500/25',
	indigo:
		'bg-indigo-500/15 text-indigo-700 group-data-hover:bg-indigo-500/25 dark:bg-indigo-500/10 dark:text-indigo-400 dark:group-data-hover:bg-indigo-500/20',
	violet:
		'bg-violet-500/15 text-violet-700 group-data-hover:bg-violet-500/25 dark:bg-violet-500/10 dark:text-violet-400 dark:group-data-hover:bg-violet-500/20',
	purple:
		'bg-purple-500/15 text-purple-700 group-data-hover:bg-purple-500/25 dark:bg-purple-500/10 dark:text-purple-400 dark:group-data-hover:bg-purple-500/20',
	fuchsia:
